...
const imageUrl = "http://localhost:4000/file-bucket/1583694106827sara.jpg";

const WorkoutClassThree = () => {
    ...
    <div>
      <div className="relative grid">
        ...
        <div className="flex justify-center h-[400px] mt-[0px]">
          ...
          <div className="flex absolute self-end font-black text-[50px] leading-[50px] mr-[10%] mb-[8%] text-[#F1C40E] ml-[0px] w-[300px]">
            {workouts}
          </div>
...
export default WorkoutClassThree;
