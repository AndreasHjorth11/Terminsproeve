...
const imageUrl = "http://localhost:4000/file-bucket/1583694100547michael.jpg";

const WorkoutClassOne = () => {
    ...
    <div>
      <div className="relative grid">
        ...
        <div className="flex justify-center h-[400px] mt-[0px]">
          ...
          <div className="flex absolute self-end font-black text-[50px] leading-[50px] mr-[45%] mb-[8%] text-[#F1C40E] ml-[60px] w-[420px]">
            {workouts}
          </div>
...
export default WorkoutClassOne;
